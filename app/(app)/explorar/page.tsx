...
import { topExpenses, topClients, revenueExpenseData } from "@/lib/mock-data"
...
const dimensoes = [
  ...
  },
  {
    ...
    serie: revenueExpenseData.map(d => ({ mes: d.mes, valor: Math.round((d.receita - d.despesa) / d.receita * 100) })),
  },
]
...
export default function ExplorarPage() {
  const [dimensao, setDimensao] = useState(dimensoes[0])
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "1400px" }}>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "18px", flexWrap: "wrap" }}>
        {dimensoes.map(d => (
          <button key={d.key} onClick={() => { setDimensao(d); setDetalhe(null) }}
            style={{
